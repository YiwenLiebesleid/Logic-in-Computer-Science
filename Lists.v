...
Fixpoint subset (s1 : bag) (s2 : bag) : bool :=
  match s1, s2 with
	| [], _ => true
	| _, [] => false
	| h :: t, _ => if (1 <=? (count h s2))
			then subset (t) (remove_one h s2) else false
	end.
...
Proof.
  intros l. induction l as [| n l' IHl'].
	- reflexivity.
	- rewrite -> IHl'. induction n as [| Sn' IHn'].
			+ reflexivity.
